...
# Step 1: Draw SVS Official Logo with perfect proportions
...
# Colors
$brushDark = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(255, 20, 44, 38))
$brushGreen = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(255, 14, 112, 58))
$brushSub = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(255, 52, 78, 72))
...
$fontHead2 = New-Object System.Drawing.Font($fontFam, 72, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)
$fontSub = New-Object System.Drawing.Font("Segoe UI", 22, [System.Drawing.FontStyle]::Regular, [System.Drawing.GraphicsUnit]::Pixel)

$textX = 160
$g.DrawString("Your Trusted Trading Partner for", $fontHead1, $brushDark, $textX, 425)
$g.DrawString("Nutraceutical Ingredients", $fontHead2, $brushGreen, ($textX - 2), 480)
$g.DrawString("Vitamins   |   Minerals   |   Botanical Extracts   |   Amino Acids   |   Speciality Ingredients", $fontSub, $brushSub, $textX, 575)

# Step 3: 4 Trust Badges
...
$finalPath = "d:\SVS\scratch\master-banner-final.png"
$banner.Save($finalPath, [System.Drawing.Imaging.ImageFormat]::Png)
$banner.Dispose()
Write-Host "Generated master-banner-final.png successfully!"
